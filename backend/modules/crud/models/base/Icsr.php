    ...
    */
    ...
    public function attributeHints()
    {
        return array_merge(
            ...
            'results_in_death' => Yii::t('app', ''),
            'life_threatening' => Yii::t('app', ''),
            'requires_hospitalization' => Yii::t('app', ''),
            'results_in_disability' => Yii::t('app', ''),
            'is_congenital_anomaly' => Yii::t('app', ''),
            'others_significant' => Yii::t('app', ''),
    ...
    public function getIcsrVersions(){
        return $this->hasMany(\backend\modules\crud\models\IcsrVersion::className(),['icsr_id' => 'id'])->orderBy('export_date DESC');
    }
    /**
     * @return \yii\db\ActiveQuery
     */
