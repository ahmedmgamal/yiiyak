...
use backend\modules\crud\models\UserCompany;
use backend\modules\crud\models\search\UserCompany as UserCompanySearch;
...
class UserCompanyController extends Controller
{
	...
	public function actionDelete($company_id, $user_id) {
		...
		$isPivot = strstr('$company_id, $user_id', ',');
		if ($isPivot == true) {
			return $this->redirect(Url::previous());
	...
	protected function findModel($company_id, $user_id) {
		if (($model = UserCompany::findOne(['company_id' => $company_id, 'user_id' => $user_id])) !== null) {
			return $model;
		} else {
