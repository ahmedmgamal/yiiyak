...
[
    ...
    'value' => ($model->getMeddraLlt()->one() ? Html::a($model->getMeddraLlt()->one()->id, ['lkp-meddra-llt/view', 'id' => $model->getMeddraLlt()->one()->id,]) : '<span class="label label-warning">?</span>'),
],
// generated by schmunk42\giiant\generators\crud\providers\RelationProvider::attributeFormat
[
    'format' => 'html',
    'attribute' => 'meddra_pt_id',
    'value' => ($model->getMeddraPt()->one() ? Html::a($model->getMeddraPt()->one()->id, ['lkp-meddra-pt/view', 'id' => $model->getMeddraPt()->one()->id,]) : '<span class="label label-warning">?</span>'),
],
        'event_date',
        'event_end_date',
            [
