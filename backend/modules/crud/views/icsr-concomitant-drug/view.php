...
?>
<div class="giiant-crud icsr-concomitant-drug-view">
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class='pull-left'>
            ...
            <?php echo Html::a('<span class="glyphicon glyphicon-copy"></span> ' . Yii::t('app', 'Copy'), ['create', 'id' => $model->id, 'IcsrConcomitantDrug            '=>$copyParams], ['class' => 'btn btn-success']) ?>
    ...
    <?php $this->beginBlock('backend\modules\crud\models\IcsrConcomitantDrug'); ?>
	...
	[
		...
		'items' => [ [
				...
				'content' => $this->blocks['backend\modules\crud\models\IcsrConcomitantDrug'],
				'active'  => true,
			], ]
	]
);
