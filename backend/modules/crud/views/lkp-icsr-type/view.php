 ...
 * @var backend\modules\crud\models\LkpIcsrType $model
 */
...
?>
<div class="giiant-crud lkp-icsr-type-view">
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class='pull-left'>
            ...
            <?php echo Html::a('<span class="glyphicon glyphicon-copy"></span> ' . Yii::t('app', 'Copy'), ['create', 'id' => $model->id, 'LkpIcsrType            '=>$copyParams], ['class' => 'btn btn-success']) ?>
    ...
    <?php $this->beginBlock('backend\modules\crud\models\LkpIcsrType'); ?>
...
<div style='position: relative'><div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?php echo Html::a(
	'<span class="glyphicon glyphicon-link"></span> ' . Yii::t('app', 'Attach') . ' Icsr', ['/crud/icsr-type/create', 'IcsrType'=>['icsr_type_lkp_id'=>$model->id]],
...
<?php $this->endBlock() ?>
	...
	[
		...
		'items' => [ [
				...
				'content' => $this->blocks['backend\modules\crud\models\LkpIcsrType'],
				'active'  => true,
			], [
