...
?>
<div class="giiant-crud lkp-weight-unit-view">
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class='pull-left'>
            ...
            <?= Html::a('<span class="glyphicon glyphicon-copy"></span> ' . Yii::t('app', 'Copy'), ['create', 'id' => $model->id, 'LkpWeightUnit            '=>$copyParams],['class' => 'btn btn-success']) ?>
    ...
    <?php $this->beginBlock('backend\modules\crud\models\LkpWeightUnit'); ?>
    ...
    'content' => $this->blocks['backend\modules\crud\models\LkpWeightUnit'],
    'active'  => true,
], ]
                 ]
    );
