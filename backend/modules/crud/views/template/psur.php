...
?>
    ...
    <div class="giiant-crud drug-index">
        <div>
            <p>
                Please Download Periodic benefit risk evaluation report Template from <a href="<?php echo Url::toRoute("template/psur-download") ?>" class="btn btn-warning glyphicon glyphicon-save"></a>
            </p>
        </div>
    </div>
