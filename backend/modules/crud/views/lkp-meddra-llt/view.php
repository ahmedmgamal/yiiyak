...
?>
<div class="giiant-crud lkp-meddra-llt-view">
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class='pull-left'>
            ...
            <?php echo Html::a('<span class="glyphicon glyphicon-copy"></span> ' . Yii::t('app', 'Copy'), ['create', 'id' => $model->id, 'LkpMeddraLlt            '=>$copyParams], ['class' => 'btn btn-success']) ?>
    ...
    <?php $this->beginBlock('backend\modules\crud\models\LkpMeddraLlt'); ?>
...
<div style='position: relative'><div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?php echo Html::a(
	...
	['/crud/icsr-event/create', 'IcsrEvent' => ['meddra_llt_id' => $model->id]],
...
<?php $this->endBlock() ?>
	...
	[
		...
		'items' => [ [
				...
				'content' => $this->blocks['backend\modules\crud\models\LkpMeddraLlt'],
				'active'  => true,
			], [
