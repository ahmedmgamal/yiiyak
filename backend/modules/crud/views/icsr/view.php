...
<div style='position: relative'><div style='position:absolute; right: 0px; top: 0px;'>
  <?= Html::a(
            ...
            ['lkp-icsr-outcome/index'],
            ['class'=>'btn text-muted btn-xs']
        ) ?>
  <?= Html::a(
            '<span class="glyphicon glyphicon-plus"></span> ' . Yii::t('app', 'New') . ' Icsr Outcome Lkp',
            ['lkp-icsr-outcome/create', 'IcsrOutcomeLkp' => ['id' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
  <?= Html::a(
            '<span class="glyphicon glyphicon-link"></span> ' . Yii::t('app', 'Attach') . ' Icsr Outcome Lkp', ['icsr-outcome/create', 'IcsrOutcome'=>['icsr_id'=>$model->id]],
...
[
    ...
    'value' => function ($model) {
        if ($rel = $model->getIcsrOutcomeLkp()->one()) {
            return Html::a($rel->id, ['lkp-icsr-outcome/view', 'id' => $rel->id,], ['data-pjax' => 0]);
        } else {
            return '';
        }
    },
