...
$form->ffield($model, 'drug_id')->dropDownList(
	...
	backend\modules\crud\models\Icsr::optspatientageunit()
			...
			<?php echo $form->field($model, 'patient_birth_date')->textInput() ?>
	...
	backend\modules\crud\models\Icsr::optspatientweightunit()
			...
			<?php echo $form->field($model, 'extra_history')->textInput(['maxlength' => true]) ?>
        </p>
        <?php $this->endBlock(); ?>
