...
?>
<div class="giiant-crud lkp-occupation-view">
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class='pull-left'>
            ...
            <?php echo Html::a('<span class="glyphicon glyphicon-copy"></span> ' . Yii::t('app', 'Copy'), ['create', 'id' => $model->id, 'LkpOccupation            '=>$copyParams], ['class' => 'btn btn-success']) ?>
    ...
    <?php $this->beginBlock('backend\modules\crud\models\LkpOccupation'); ?>
...
<div style='position: relative'><div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?php echo Html::a(
	...
	['/crud/icsr-reporter/create', 'IcsrReporter' => ['occupation_lkp_id' => $model->id]],
...
<?php $this->endBlock() ?>
	...
	[
		...
		'items' => [ [
				...
				'content' => $this->blocks['backend\modules\crud\models\LkpOccupation'],
				'active'  => true,
			], [
