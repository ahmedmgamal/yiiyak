 ...
 * @var backend\modules\crud\models\search\LkpMeddraPt $searchModel
 */
$this->title = $searchModel->getAliasModel(true);
$this->params['breadcrumbs'][] = $this->title;
?>

<div class="giiant-crud lkp-meddra-pt-index">
	...
	[
		...
		'dropdown' => [
			...
			'items' => [            [
					...
					'url' => ['/crud/lkp-meddra-hlgt/index'],
					'label' => '<i class="glyphicon glyphicon-arrow-right">&nbsp;' . Yii::t('app', 'Lkp Meddra Hlgt') . '</i>',
				], ]
		],
		'options' => [
			'class' => 'btn-default'
		...
		'columns' => [
			...
			[
				...
				'value' => function ($model) {
					if ($rel = $model->getMeddraHlgt()->one()) {
						return Html::a($rel->id, ['/crud/lkp-meddra-hlgt/view', 'id' => $rel->id, ], ['data-pjax' => 0]);
					} else {
						return '';
					}
				},
