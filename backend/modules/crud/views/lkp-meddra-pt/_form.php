...
$form->field($model, 'meddra_hlgt_id')->dropDownList(
	\yii\helpers\ArrayHelper::map(backend\modules\crud\models\LkpMeddraHlgt::find()->all(), 'id', 'id'),
