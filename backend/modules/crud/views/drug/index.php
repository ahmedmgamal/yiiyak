	...
	[
		...
		'dropdown' => [
			...
			'items' => [            [
					...
					'url' => ['/crud/lkp-route/index'],
					'label' => '<i class="glyphicon glyphicon-arrow-right">&nbsp;' . Yii::t('app', 'Lkp Route') . '</i>',
				],            [
			...
			[
				...
				'value' => function ($model) {
					if ($rel = $model->getRouteLkp()->one()) {
						return Html::a($rel->description, ['/crud/lkp-route/view', 'id' => $rel->id, ], ['data-pjax' => 0]);
					} else {
						return '';
					}
				},
