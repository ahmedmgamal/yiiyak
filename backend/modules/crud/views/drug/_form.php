...
$form->field($model, 'company_id')->dropDownList(
	\yii\helpers\ArrayHelper::map(backend\modules\crud\models\Company::find()->all(), 'id', 'name'),
	['prompt' => Yii::t('app', 'Select')]
			...
			<?php echo // generated by schmunk42\giiant\generators\crud\providers\RelationProvider::activeField
$form->field($model, 'route_lkp_id')->dropDownList(
	\yii\helpers\ArrayHelper::map(backend\modules\crud\models\LkpRoute::find()->all(), 'id', 'id'),
	['prompt' => Yii::t('app', 'Select')]
); ?>
        </p>
        <?php $this->endBlock(); ?>
