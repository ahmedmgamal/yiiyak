 ...
 * @var backend\modules\crud\models\search\IcsrTest $searchModel
 */
$this->title = $searchModel->getAliasModel(true);
$this->params['breadcrumbs'][] = $this->title;
?>

<div class="giiant-crud icsr-test-index">
	...
	[
		...
		'dropdown' => [
			...
			'items' => [            [
					...
					'url' => ['/crud/lkp-test/index'],
					'label' => '<i class="glyphicon glyphicon-arrow-right">&nbsp;' . Yii::t('app', 'Lkp Test') . '</i>',
				], ]
		],
		'options' => [
			'class' => 'btn-default'
